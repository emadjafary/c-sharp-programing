...
class Zhaket_Guard_SDK {
	...
	public function __construct(array $settings) {
		...
		add_action('wp_ajax_zhk_guard_wp_starter', array($this, 'wp_starter'));

		add_action('wp_ajax_zhk_guard_revalidate', array($this, 'revalidate_starter'));
